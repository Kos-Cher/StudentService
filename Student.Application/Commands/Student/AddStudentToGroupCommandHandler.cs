...
{
    public class AddStudentToGroupCommandHandler : IRequestHandler<AddStudentToGroupCommand,AddStudentToGroupResult>
    {
        private readonly IStudentDbContext _context;

        public AddStudentToGroupCommandHandler(IStudentDbContext context)
        {
            _context = context;
        }

        public async Task<AddStudentToGroupResult> Handle(AddStudentToGroupCommand request, CancellationToken cancellationToken)
        {
            var result = new AddStudentToGroupResult() { Errors = new List<string>()};
